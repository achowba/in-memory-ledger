 ...
 *
 * @remarks
 * Zero, and the comparison is strict. A day that closes at exactly 0.00 is not overdrawn, so
 * a flat account is never charged. Written as `<= 0n` this would put a fee on an account
 * that owes nothing, which is both wrong and the kind of wrong a customer notices.
 */
