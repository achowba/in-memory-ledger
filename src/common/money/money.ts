 ...
 *
 * This is an alias rather than a branded type. A brand would force a cast at every literal,
 * which costs more in readability than it buys in safety. There is no second numeric money
 * representation anywhere in the codebase to confuse it with. The naming convention also puts
 * `Minor` on the end of every money identifier.
 */
 ...
 * is a fault for AED and a valid amount for BHD.
 *
